...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 499,033 | 🐛 106 | 📅 2026-08-21.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,149 | 🐛 25 | 📅 2024-06-07 - Some overlap here for artifact analysis.
* [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,414 | 🐛 14 | 📅 2025-09-03 - Useful in network traffic analysis.
...
* Database Honeypots
  ...
  * [Elastic honey](https://github.com/jordan-wright/elastichoney) ⭐ 192 | 🐛 6 | 🌐 Go | 📅 2015-07-14 - A Simple Elasticsearch Honeypot.

  * [Elastic honey](https://github.com/jordan-wright/elastichoney) ⭐ 192 | 🐛 6 | 🌐 Go | 📅 2015-07-14 - Simple Elasticsearch Honeypot.
  ...
  * [MongoDB-HoneyProxy](https://github.com/Plazmaz/MongoDB-HoneyProxy) ⭐ 91 | 🐛 1 | 🌐 JavaScript | 📅 2023-02-20 - A MongoDB honeypot proxy.

  * [MongoDB-HoneyProxy](https://github.com/Plazmaz/MongoDB-HoneyProxy) ⭐ 91 | 🐛 1 | 🌐 JavaScript | 📅 2023-02-20 - MongoDB honeypot proxy.

  * [mysql-honeypotd](https://github.com/sjinks/mysql-honeypotd) ⭐ 37 | 🐛 0 | 🌐 C | 📅 2026-08-21 - Low interaction MySQL honeypot written in C.
...
* Web honeypots
  ...
  * [HellPot](https://github.com/yunginnanet/HellPot) ⭐ 1,144 | 🐛 13 | 🌐 Go | 📅 2025-12-19 - Honeypot that tries to crash the bots and clients that visit it's location.
  ...
  * [galah](https://github.com/0x4D31/galah) ⭐ 662 | 🐛 6 | 🌐 Go | 📅 2025-07-24 - an LLM-powered web honeypot using the OpenAI API.
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 641 | 🐛 9 | 🌐 Python | 📅 2026-08-22 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  * [Glastopf](https://github.com/mushorg/glastopf) ⭐ 602 | 🐛 1 | 🌐 Python | 📅 2024-07-23 - Web Application Honeypot.
  ...
  * [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 190 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-23 - Self-hosted CAPTCHA that acts as an inline honeypot, detecting bots and vision AI agents through 40+ behavioral signals, headless browser fingerprinting, and SHA-256 proof of work.
  ...
  * [EoHoneypotBundle](https://github.com/eymengunay/EoHoneypotBundle) ⭐ 38 | 🐛 6 | 🌐 PHP | 📅 2026-02-19 - Honeypot type for Symfony2 forms.
  ...
  * [Lophiid](https://github.com/mrheinen/lophiid/) ⭐ 28 | 🐛 21 | 🌐 Go | 📅 2026-04-28 - Distributed web application honeypot to interact with large scale exploitation attempts.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-22 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
  ...
  * Snare/Tanner - successors to Glastopf
    * [Snare](https://github.com/mushorg/snare) ⭐ 481 | 🐛 29 | 🌐 Python | 📅 2024-06-10 - Super Next generation Advanced Reactive honeypot.
  ...
  * WordPress honeypots
    ...
    * [WebDecoy](https://github.com/WebDecoy/wordpress-plugin) ⭐ 1 | 🐛 1 | 🌐 PHP | 📅 2026-08-23 - Zero-configuration WordPress plugin with invisible honeypot fields, behavioral analysis, and SHA-256 proof-of-work challenges to detect bots, headless browsers, and automation frameworks.

* Service Honeypots
  * [pyrdp](https://github.com/gosecure/pyrdp) ⭐ 1,776 | 🐛 62 | 🌐 Python | 📅 2026-05-13 - RDP man-in-the-middle and library for Python 3 with the ability to watch connections live or after the fact.
  ...
  * [dionaea](https://github.com/DinoTools/dionaea) ⭐ 815 | 🐛 65 | 🌐 Python | 📅 2024-08-01 - Home of the dionaea honeypot.
...
* ICS/SCADA honeypots
  ...
  * [HoneyPLC](https://github.com/sefcom/honeyplc) ⭐ 101 | 🐛 4 | 🌐 Pascal | 📅 2023-05-16 - Mimics multiple PLC devices, including Siemenens and Rockewell
...
* Other/random
  ...
  * [OpenCanary](https://github.com/thinkst/opencanary) ⭐ 2,995 | 🐛 12 | 🌐 Python | 📅 2026-08-18 - Modular and decentralised honeypot daemon that runs several canary versions of services that alerts when a service is (ab)used.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,202 | 🐛 45 | 🌐 Python | 📅 2026-08-13 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,427 | 🐛 3 | 🌐 Shell | 📅 2026-08-22 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2,155 | 🐛 7 | 🌐 Go | 📅 2026-08-21 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* SSH Honeypots
  ...
  * [endlessh](https://github.com/skeeto/endlessh) ⭐ 8,542 | 🐛 49 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner. ([docker image](https://hub.docker.com/r/linuxserver/endlessh))
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,502 | 🐛 110 | 🌐 Python | 📅 2026-08-22 - Cowrie SSH Honeypot (based on kippo).
  ...
  * [hnypots-agent)](https://github.com/joshrendek/hnypots-agent) ⭐ 39 | 🐛 1 | 🌐 PureBasic | 📅 2026-08-14 - SSH Server in Go that logs username and password combinations.
  ...
  * [ssh-honeypotd](https://github.com/sjinks/ssh-honeypotd) ⭐ 20 | 🐛 3 | 🌐 C | 📅 2026-08-21 - Low-interaction SSH honeypot written in C.
...
* Server (Bluetooth)
  ...
  * [Bluepot](https://github.com/andrewmichaelsmith/bluepot) ⭐ 277 | 🐛 4 | 🌐 Java | 📅 2026-04-02
...
* Dockerized Low Interaction packaging
  ...
  * [Dockerized Thug](https://hub.docker.com/r/honeynet/thug/) - Dockerized [Thug](https://github.com/buffer/thug) ⭐ 1,041 | 🐛 6 | 🌐 Python | 📅 2026-08-18 to analyze malicious web content.
...
* SIP
  ...
  * [SentryPeer](https://github.com/SentryPeer/SentryPeer) ⭐ 212 | 🐛 2 | 🌐 C | 📅 2026-08-21 - Protect your SIP Servers from bad actors.

* IOT Honeypot

  * [HoneyThing](https://github.com/omererdem/honeything) ⭐ 128 | 🐛 4 | 🌐 Python | 📅 2016-03-16 - TR-069 Honeypot.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,117 | 🐛 5 | 🌐 Python | 📅 2026-08-20 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
