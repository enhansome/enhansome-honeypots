...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 510,638 | 🐛 107 | 📅 2026-09-02.
...
* [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,429 | 🐛 14 | 📅 2025-09-03 - Useful in network traffic analysis.
...
* Web honeypots
  ...
  * [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 215 | 🐛 1 | 🌐 JavaScript | 📅 2026-09-25 - Self-hosted CAPTCHA that acts as an inline honeypot, detecting bots and vision AI agents through 40+ behavioral signals, headless browser fingerprinting, and SHA-256 proof of work.
...
* VM monitoring and tools
  ...
  * [VMCloak](https://github.com/hatching/vmcloak) ⭐ 522 | 🐛 65 | 🌐 Python | 📅 2024-05-14 - Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,295 | 🐛 1 | 🌐 Python | 📅 2026-09-22 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,527 | 🐛 0 | 🌐 Shell | 📅 2026-09-24 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2,182 | 🐛 8 | 🌐 Go | 📅 2026-09-25 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* SSH Honeypots
  ...
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,552 | 🐛 67 | 🌐 Python | 📅 2026-09-26 - Cowrie SSH Honeypot (based on kippo).
...
* Honeyd stats
  * [Honeydsum.pl](https://github.com/DataSoft/Honeyd/blob/master/scripts/misc/honeydsum-v0.3/honeydsum.pl) ⭐ 396 | 🐛 31 | 🌐 C | 📅 2023-05-20
