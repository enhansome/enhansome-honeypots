...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 497,490 | 🐛 102 | 📅 2026-08-18.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,133 | 🐛 25 | 📅 2024-06-07 - Some overlap here for artifact analysis.
...
* Database Honeypots
  ...
  * [mysql-honeypotd](https://github.com/sjinks/mysql-honeypotd) ⭐ 37 | 🐛 0 | 🌐 C | 📅 2026-08-13 - Low interaction MySQL honeypot written in C.
...
* Web honeypots
  ...
  * [HellPot](https://github.com/yunginnanet/HellPot) ⭐ 1,143 | 🐛 13 | 🌐 Go | 📅 2025-12-19 - Honeypot that tries to crash the bots and clients that visit it's location.
  ...
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 635 | 🐛 11 | 🌐 Python | 📅 2026-08-18 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  ...
  * [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 187 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-28 - Self-hosted CAPTCHA that acts as an inline honeypot, detecting bots and vision AI agents through 40+ behavioral signals, headless browser fingerprinting, and SHA-256 proof of work.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-18 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
...
* Service Honeypots
  ...
  * [Honeyport](https://github.com/securitygeneration/Honeyport) ⭐ 48 | 🐛 0 | 🌐 Shell | 📅 2017-02-22 - Simple honeyport written in Bash and Python.
...
* Other/random
  ...
  * [OpenCanary](https://github.com/thinkst/opencanary) ⭐ 2,993 | 🐛 12 | 🌐 Python | 📅 2026-08-18 - Modular and decentralised honeypot daemon that runs several canary versions of services that alerts when a service is (ab)used.
...
* System instrumentation
  ...
  * [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,527 | 🐛 43 | 🌐 Go | 📅 2026-08-12 - Tool for exploration and tracing of the Windows kernel.
...
* VM monitoring and tools
  ...
  * [VMCloak](https://github.com/hatching/vmcloak) ⭐ 520 | 🐛 65 | 🌐 Python | 📅 2024-05-14 - Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,198 | 🐛 46 | 🌐 Python | 📅 2026-08-13 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,420 | 🐛 3 | 🌐 Shell | 📅 2026-08-04 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2,150 | 🐛 6 | 🌐 Go | 📅 2026-08-18 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* Server
  ...
  * [MTPot](https://github.com/Cymmetria/MTPot) ⭐ 108 | 🐛 0 | 🌐 Python | 📅 2017-03-20 - Open Source Telnet Honeypot, focused on Mirai malware.
...
* SSH Honeypots
  ...
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,496 | 🐛 118 | 🌐 Python | 📅 2026-08-18 - Cowrie SSH Honeypot (based on kippo).
  * [sshesame](https://github.com/jaksi/sshesame) ⭐ 1,740 | 🐛 17 | 🌐 Go | 📅 2024-10-21 - Fake SSH server that lets everyone in and logs their activity.
  ...
  * [ssh-honeypotd](https://github.com/sjinks/ssh-honeypotd) ⭐ 20 | 🐛 3 | 🌐 C | 📅 2026-08-13 - Low-interaction SSH honeypot written in C.
...
* Dockerized Low Interaction packaging
  ...
  * [Dockerized Thug](https://hub.docker.com/r/honeynet/thug/) - Dockerized [Thug](https://github.com/buffer/thug) ⭐ 1,040 | 🐛 6 | 🌐 Python | 📅 2026-08-18 to analyze malicious web content.
...
* SIP
  ...
  * [SentryPeer](https://github.com/SentryPeer/SentryPeer) ⭐ 212 | 🐛 0 | 🌐 C | 📅 2026-08-18 - Protect your SIP Servers from bad actors.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,113 | 🐛 5 | 🌐 Python | 📅 2026-08-18 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
