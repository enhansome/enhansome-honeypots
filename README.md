...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 502,515 | 🐛 105 | 📅 2026-09-02.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,178 | 🐛 25 | 📅 2024-06-07 - Some overlap here for artifact analysis.
* [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,418 | 🐛 14 | 📅 2025-09-03 - Useful in network traffic analysis.
...
* Database Honeypots
  * [Acra](https://github.com/cossacklabs/acra) ⭐ 1,491 | 🐛 29 | 🌐 Go | 📅 2026-04-23 - Effective SQL database protection suite: strong selective encryption, SQL injections prevention, intrusion detection system based on using honeypots/poison records in the database.

  * [Elastic honey](https://github.com/jordan-wright/elastichoney) ⭐ 193 | 🐛 6 | 🌐 Go | 📅 2015-07-14 - A Simple Elasticsearch Honeypot.

  * [Elastic honey](https://github.com/jordan-wright/elastichoney) ⭐ 193 | 🐛 6 | 🌐 Go | 📅 2015-07-14 - Simple Elasticsearch Honeypot.

  * [NoSQLpot](https://github.com/torque59/nosqlpot) ⭐ 104 | 🐛 5 | 🌐 Python | 📅 2023-10-17 - The NoSQL Honeypot Framework.

  * [NoSQLpot](https://github.com/torque59/nosqlpot) ⭐ 104 | 🐛 5 | 🌐 Python | 📅 2023-10-17 - Honeypot framework built on a NoSQL-style database.

  * [MongoDB-HoneyProxy](https://github.com/Plazmaz/MongoDB-HoneyProxy) ⭐ 92 | 🐛 1 | 🌐 JavaScript | 📅 2023-02-20 - A MongoDB honeypot proxy.

  * [MongoDB-HoneyProxy](https://github.com/Plazmaz/MongoDB-HoneyProxy) ⭐ 92 | 🐛 1 | 🌐 JavaScript | 📅 2023-02-20 - MongoDB honeypot proxy.

  * [mysql-honeypotd](https://github.com/sjinks/mysql-honeypotd) ⭐ 37 | 🐛 0 | 🌐 C | 📅 2026-08-27 - Low interaction MySQL honeypot written in C.
  ...
  * [MysqlPot](https://github.com/schmalle/MysqlPot) ⭐ 22 | 🐛 0 | 🌐 C# | 📅 2012-10-14 - A mysql honeypot, still very very early stage.
  ...
  * [sticky\_elephant](https://github.com/betheroot/sticky_elephant) ⭐ 13 | 🐛 0 | 🌐 Ruby | 📅 2024-08-06 - medium interaction postgresql honeypot.
...
* Blockchain honeypots
  * [Ethereum-honey-pot](https://github.com/jeremyfritzen/Ethereum-honey-pot) ⭐ 13 | 🐛 3 | 🌐 Shell | 📅 2023-11-17 - Tool hacking-back hackers who tried to steal tokens.

* Web honeypots

  * [HellPot](https://github.com/yunginnanet/HellPot) ⭐ 1,147 | 🐛 13 | 🌐 Go | 📅 2025-12-19 - Honeypot that tries to crash the bots and clients that visit it's location.
  * [django-admin-honeypot](https://github.com/dmpayton/django-admin-honeypot) ⭐ 1,084 | 🐛 19 | 🌐 Python | 📅 2024-04-10 - Fake Django admin login screen to notify admins of attempted unauthorized access.
  * [galah](https://github.com/0x4D31/galah) ⭐ 663 | 🐛 6 | 🌐 Go | 📅 2025-07-24 - an LLM-powered web honeypot using the OpenAI API.
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 645 | 🐛 10 | 🌐 Python | 📅 2026-09-02 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  * [Glastopf](https://github.com/mushorg/glastopf) ⭐ 603 | 🐛 1 | 🌐 Python | 📅 2024-07-23 - Web Application Honeypot.
  ...
  * [Laravel Application Honeypot](https://github.com/msurguy/Honeypot) ⭐ 437 | 🐛 10 | 🌐 PHP | 📅 2026-04-08 - Simple spam prevention package for Laravel applications.
  * [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 197 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-30 - Self-hosted CAPTCHA that acts as an inline honeypot, detecting bots and vision AI agents through 40+ behavioral signals, headless browser fingerprinting, and SHA-256 proof of work.
  * [Cloud Active Defense](https://github.com/SAP/cloud-active-defense?tab=readme-ov-file) ⭐ 106 | 🐛 33 | 🌐 JavaScript | 📅 2026-09-02 - Cloud active defense lets you deploy decoys right into your cloud applications, putting adversaries into a dilemma: to hack or not to hack?
  ...
  * [WebTrap](https://github.com/IllusiveNetworks-Labs/WebTrap) ⭐ 67 | 🐛 2 | 🌐 Python | 📅 2018-03-28 - Designed to create deceptive webpages to deceive and redirect attackers away from real websites.
  ...
  * [basic-auth-pot (bap)](https://github.com/bjeborn/basic-auth-pot) ⭐ 55 | 🐛 0 | 🌐 Python | 📅 2015-01-15 - HTTP Basic Authentication honeypot.
  * [honeyhttpd](https://github.com/bocajspear1/honeyhttpd) ⭐ 55 | 🐛 7 | 🌐 Python | 📅 2024-06-29 - Python-based web server honeypot builder.
  * [Nodepot](https://github.com/schmalle/Nodepot) ⭐ 50 | 🐛 1 | 🌐 HTML | 📅 2015-08-23 - NodeJS web application honeypot.
  * [EoHoneypotBundle](https://github.com/eymengunay/EoHoneypotBundle) ⭐ 39 | 🐛 6 | 🌐 PHP | 📅 2026-02-19 - Honeypot type for Symfony2 forms.
  * [honeyup](https://github.com/LogoiLab/honeyup) ⭐ 31 | 🐛 0 | 🌐 Rust | 📅 2025-04-19 - An uploader honeypot designed to look like poor website security.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-09-03 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
  ...
  * Snare/Tanner - successors to Glastopf
    * [Snare](https://github.com/mushorg/snare) ⭐ 481 | 🐛 30 | 🌐 Python | 📅 2024-06-10 - Super Next generation Advanced Reactive honeypot.
    * [Tanner](https://github.com/mushorg/tanner) ⭐ 231 | 🐛 29 | 🌐 Python | 📅 2024-08-19 - Evaluating SNARE events.
  * WordPress honeypots
    * [wordpot](https://github.com/gbrindisi/wordpot) ⭐ 189 | 🐛 4 | 🌐 CSS | 📅 2023-02-07 - WordPress Honeypot.
    ...
    * [WebDecoy](https://github.com/WebDecoy/wordpress-plugin) ⭐ 1 | 🐛 1 | 🌐 PHP | 📅 2026-08-28 - Zero-configuration WordPress plugin with invisible honeypot fields, behavioral analysis, and SHA-256 proof-of-work challenges to detect bots, headless browsers, and automation frameworks.

* Service Honeypots
  * [pyrdp](https://github.com/gosecure/pyrdp) ⭐ 1,780 | 🐛 63 | 🌐 Python | 📅 2026-05-13 - RDP man-in-the-middle and library for Python 3 with the ability to watch connections live or after the fact.
  * [RDPy](https://github.com/citronneur/rdpy) ⭐ 1,735 | 🐛 78 | 🌐 Python | 📅 2021-06-28 - Microsoft Remote Desktop Protocol (RDP) honeypot implemented in Python.
  * [honeytrap](https://github.com/honeytrap/honeytrap) ⭐ 1,307 | 🐛 148 | 🌐 Go | 📅 2023-10-09 - Advanced Honeypot framework written in Go that can be connected with other honeypot software.
  * [honeypots](https://github.com/qeeqbox/honeypots) ⭐ 987 | 🐛 14 | 🌐 Python | 📅 2025-12-03 - 25 different honeypots in a single pypi package! (dns, ftp, httpproxy, http, https, imap, mysql, pop3, postgres, redis, smb, smtp, socks5, ssh, telnet, vnc, mssql, elastic, ldap, ntp, memcache, snmp, oracle, sip and irc).
  * [dionaea](https://github.com/DinoTools/dionaea) ⭐ 817 | 🐛 65 | 🌐 Python | 📅 2024-08-01 - Home of the dionaea honeypot.
  ...
  * [Trapster Commmunity](https://github.com/0xBallpoint/trapster-community) ⭐ 164 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - Modural and easy to install Python Honeypot, with comprehensive alerting
  ...
  * [dhp](https://github.com/ciscocsirt/dhp) ⭐ 35 | 🐛 1 | 🌐 Python | 📅 2020-10-06 - Simple Docker Honeypot server emulating small snippets of the Docker HTTP API.
...
* Anti-honeypot stuff
  ...
  * [honeydet](https://github.com/referefref/honeydet) ⭐ 112 | 🐛 0 | 🌐 Go | 📅 2025-03-22 - Signature based honeypot detector tool written in Golang
...
* Space/Satellite honeypots
  ...
  * [HoneySat](https://github.com/HoneySat/honeysat-deploy) ⭐ 1 | 🐛 0 | 🌐 JavaScript | 📅 2025-07-08 - Mimics multiple satellite missions

* Other/random

  * [OpenCanary](https://github.com/thinkst/opencanary) ⭐ 3,011 | 🐛 13 | 🌐 Python | 📅 2026-08-18 - Modular and decentralised honeypot daemon that runs several canary versions of services that alerts when a service is (ab)used.
  ...
  * [Log4Pot](https://github.com/thomaspatzke/Log4Pot) ⭐ 94 | 🐛 0 | 🌐 Python | 📅 2024-11-29 - A honeypot for the Log4Shell vulnerability (CVE-2021-44228).
  * [NOVA](https://github.com/DataSoft/Nova) ⭐ 81 | 🐛 6 | 🌐 C++ | 📅 2023-06-08 - Uses honeypots as detectors, looks like a complete system.
  * [ciscoasa\_honeypot](https://github.com/cymmetria/ciscoasa_honeypot) ⭐ 55 | 🐛 5 | 🌐 JavaScript | 📅 2018-11-23 A low interaction honeypot for the Cisco ASA component capable of detecting CVE-2018-0101, a DoS and remote code execution vulnerability.
  * [dicompot](https://github.com/nsmfoo/dicompot) ⭐ 28 | 🐛 1 | 🌐 Go | 📅 2026-05-11 - DICOM Honeypot.
  ...
  * [Damn Simple Honeypot (DSHP)](https://github.com/naorlivne/dshp) ⭐ 18 | 🐛 0 | 🌐 Python | 📅 2016-05-31 - Honeypot framework with pluggable handlers.
  * [FortiGate SSL-VPN Honeypot](https://github.com/PeterGabaldon/Fortigate.VPN-SSL.Honeypot) ⭐ 12 | 🐛 0 | 🌐 Python | 📅 2026-06-28 - Mimics FortiGate SSL-VPN devices to capture brute-force attempts, symlink exploit probes, and malicious IP telemetry.
  * [IPP Honey](https://gitlab.com/bontchev/ipphoney) - A honeypot for the Internet Printing Protocol.

* Botnet C2 tools

  * [Hale](https://github.com/pjlantz/Hale) ⭐ 202 | 🐛 2 | 🌐 Python | 📅 2022-05-23 - Botnet command and control monitor.
...
* IPv6 attack detection tool
  ...
  * [ipv6-attack-detector](https://github.com/mzweilin/ipv6-attack-detector/) ⭐ 44 | 🐛 0 | 🌐 Python | 📅 2020-07-30 - Google Summer of Code 2012 project, supported by The Honeynet Project organization.
...
* Dynamic Deception Tool
  ...
  * [Mimicry](https://github.com/chaitin/mimicry) ⭐ 62 | 🐛 0 | 🌐 Dockerfile | 📅 2026-03-20 - Mimicry is a dynamic deception tool that actively deceives an attacker during exploitation and post-exploitation.

* Low interaction honeypot (router back door)

  * [WAPot](https://github.com/lcashdol/WAPot) ⭐ 21 | 🐛 0 | 🌐 CSS | 📅 2018-11-14 - Honeypot that can be used to observe traffic directed at home routers.
...
* System instrumentation
  ...
  * [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,537 | 🐛 42 | 🌐 Go | 📅 2026-09-01 - Tool for exploration and tracing of the Windows kernel.
...
* Honeypot for USB-spreading malware
  ...
  * [Ghost-usb](https://github.com/honeynet/ghost-usb-honeypot) ⭐ 104 | 🐛 3 | 🌐 C | 📅 2015-03-24 - Honeypot for malware that propagates via USB storage devices.
...
* VM monitoring and tools
  ...
  * [Antivmdetect](https://github.com/nsmfoo/antivmdetection) ⭐ 780 | 🐛 11 | 🌐 Python | 📅 2022-11-05 - Script to create templates to use with VirtualBox to make VM detection harder.
  * [VMCloak](https://github.com/hatching/vmcloak) ⭐ 521 | 🐛 65 | 🌐 Python | 📅 2024-05-14 - Automated Virtual Machine Generation and Cloaking for Cuckoo Sandbox.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,224 | 🐛 45 | 🌐 Python | 📅 2026-08-13 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,452 | 🐛 0 | 🌐 Shell | 📅 2026-09-02 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2,167 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* Server
  ...
  * [fapro](https://github.com/fofapro/fapro) ⭐ 1,610 | 🐛 14 | 🌐 Python | 📅 2025-01-02 - Fake Protocol Server.
  * [Artillery](https://github.com/BinaryDefense/artillery) ⭐ 1,040 | 🐛 25 | 🌐 Python | 📅 2022-01-06 - Open-source blue team tool designed to protect Linux and Windows operating systems through multiple methods.
  * [Heralding](https://github.com/johnnykv/heralding) ⭐ 395 | 🐛 20 | 🌐 Python | 📅 2024-05-21 - Credentials catching honeypot.
  ...
  * [glutton](https://github.com/mushorg/glutton) ⭐ 307 | 🐛 23 | 🌐 Go | 📅 2026-08-30 - All eating honeypot.
  ...
  * [honeytrap](https://github.com/tillmannw/honeytrap) ⭐ 97 | 🐛 4 | 🌐 C | 📅 2017-06-04 - Low-interaction honeypot and network security tool written to catch attacks against TCP and UDP services.
  * [UDPot Honeypot](https://github.com/jekil/UDPot) ⭐ 50 | 🐛 0 | 🌐 Python | 📅 2026-01-23 - Simple UDP/DNS honeypot scripts.
  * [go-HoneyPot](https://github.com/Mojachieee/go-HoneyPot) ⭐ 49 | 🐛 0 | 🌐 Go | 📅 2019-10-05 - Honeypot server written in Go.
  * [portlurker](https://github.com/bartnv/portlurker) ⭐ 36 | 🐛 1 | 🌐 Rust | 📅 2026-04-24 - Port listener in Rust with protocol guessing and safe string display.
  ...
  * [imap-honey](https://github.com/yvesago/imap-honey) ⭐ 25 | 🐛 0 | 🌐 Go | 📅 2022-04-22 - IMAP honeypot written in Golang.
...
* Client
  ...
  * [Jsunpack-n](https://github.com/urule99/jsunpack-n) ⭐ 169 | 🐛 30 | 🌐 Python | 📅 2015-04-02
...
* SSH Honeypots
  ...
  * [endlessh](https://github.com/skeeto/endlessh) ⭐ 8,544 | 🐛 50 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner. ([docker image](https://hub.docker.com/r/linuxserver/endlessh))
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,512 | 🐛 117 | 🌐 Python | 📅 2026-08-31 - Cowrie SSH Honeypot (based on kippo).
  * [sshesame](https://github.com/jaksi/sshesame) ⭐ 1,741 | 🐛 17 | 🌐 Go | 📅 2024-10-21 - Fake SSH server that lets everyone in and logs their activity.
  * [Kippo](https://github.com/desaster/kippo) ⭐ 1,714 | 🐛 83 | 🌐 Python | 📅 2023-11-19 - Medium interaction SSH honeypot.
  * [ssh-honeypot](https://github.com/droberson/ssh-honeypot) ⭐ 675 | 🐛 11 | 🌐 C | 📅 2024-10-29 - Fake sshd that logs IP addresses, usernames, and passwords.
  ...
  * [MockSSH](https://github.com/ncouture/MockSSH) ⭐ 130 | 🐛 10 | 🌐 Python | 📅 2026-07-09 - Mock an SSH server and define all commands it supports (Python, Twisted).
  ...
  * [hnypots-agent)](https://github.com/joshrendek/hnypots-agent) ⭐ 39 | 🐛 1 | 🌐 PureBasic | 📅 2026-09-02 - SSH Server in Go that logs username and password combinations.
  ...
  * [honeypot.go](https://github.com/mdp/honeypot.go) ⭐ 31 | 🐛 0 | 🌐 Go | 📅 2013-12-20 - SSH Honeypot written in Go.
  ...
  * [ssh-auth-logger](https://github.com/JustinAzoff/ssh-auth-logger) ⭐ 25 | 🐛 4 | 🌐 Go | 📅 2026-05-29 - Low/zero interaction SSH authentication logging honeypot.
  ...
  * [ssh-honeypotd](https://github.com/sjinks/ssh-honeypotd) ⭐ 19 | 🐛 3 | 🌐 C | 📅 2026-09-01 - Low-interaction SSH honeypot written in C.
  ...
  * [gohoney](https://github.com/PaulMaddox/gohoney) ⭐ 14 | 🐛 1 | 🌐 Go | 📅 2013-12-12 - SSH honeypot written in Go.
...
* Spamtrap
  ...
  * [Mailoney](https://github.com/phin3has/mailoney) ⭐ 284 | 🐛 0 | 🌐 Python | 📅 2026-05-22 - SMTP honeypot written in python.
  * [Shiva](https://github.com/shiva-spampot/shiva) ⭐ 136 | 🐛 9 | 🌐 Python | 📅 2025-03-31 - Spam Honeypot with Intelligent Virtual Analyzer.
...
* Server (Bluetooth)
  ...
  * [Bluepot](https://github.com/andrewmichaelsmith/bluepot) ⭐ 278 | 🐛 4 | 🌐 Java | 📅 2026-04-02
...
* Dockerized Low Interaction packaging
  ...
  * [Dockerized Thug](https://hub.docker.com/r/honeynet/thug/) - Dockerized [Thug](https://github.com/buffer/thug) ⭐ 1,042 | 🐛 8 | 🌐 Python | 📅 2026-08-24 to analyze malicious web content.
...
* SIP
  ...
  * [SentryPeer](https://github.com/SentryPeer/SentryPeer) ⭐ 211 | 🐛 3 | 🌐 C | 📅 2026-08-28 - Protect your SIP Servers from bad actors.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,144 | 🐛 5 | 🌐 Python | 📅 2026-09-02 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
  * [Honeyλ (HoneyLambda)](https://github.com/0x4D31/honeylambda) ⭐ 525 | 🐛 1 | 🌐 Python | 📅 2018-10-20 - Simple, serverless application designed to create and monitor URL honeytokens, on top of AWS Lambda and Amazon API Gateway.
  * [dcept](https://github.com/secureworks/dcept) ⭐ 505 | 🐛 4 | 🌐 Python | 📅 2022-07-13 - Tool for deploying and detecting use of Active Directory honeytokens.
...
* Honeyd stats
  * [Honeydsum.pl](https://github.com/DataSoft/Honeyd/blob/master/scripts/misc/honeydsum-v0.3/honeydsum.pl) ⭐ 395 | 🐛 31 | 🌐 C | 📅 2023-05-20
...
* Sandbox
  ...
  * [libemu](https://github.com/buffer/libemu) ⭐ 155 | 🐛 7 | 🌐 C | 📅 2024-03-27 - Shellcode emulation library, useful for shellcode detection.
...
* Visualization
  ...
  * [Afterglow Cloud](https://github.com/ayrus/afterglow-cloud) ⭐ 17 | 🐛 0 | 🌐 Perl | 📅 2013-05-04
  ...
  * [SSH-Radar](https://github.com/antonsatt/ssh-radar) ⭐ 2 | 🐛 0 | 🌐 Python | 📅 2026-06-21 - Real-time monitoring and visualization of failed SSH login attempts with geolocation and Grafana dashboards.
