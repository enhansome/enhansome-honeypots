...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 501,830 | 🐛 105 | 📅 2026-08-21.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,172 | 🐛 25 | 📅 2024-06-07 - Some overlap here for artifact analysis.
...
* Web honeypots
  ...
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 643 | 🐛 10 | 🌐 Python | 📅 2026-08-31 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-09-01 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
...
* Service Honeypots
  ...
  * [honeytrap](https://github.com/honeytrap/honeytrap) ⭐ 1,306 | 🐛 148 | 🌐 Go | 📅 2023-10-09 - Advanced Honeypot framework written in Go that can be connected with other honeypot software.
  * [honeypots](https://github.com/qeeqbox/honeypots) ⭐ 986 | 🐛 14 | 🌐 Python | 📅 2025-12-03 - 25 different honeypots in a single pypi package! (dns, ftp, httpproxy, http, https, imap, mysql, pop3, postgres, redis, smb, smtp, socks5, ssh, telnet, vnc, mssql, elastic, ldap, ntp, memcache, snmp, oracle, sip and irc).
...
* Other/random
  ...
  * [OpenCanary](https://github.com/thinkst/opencanary) ⭐ 3,008 | 🐛 13 | 🌐 Python | 📅 2026-08-18 - Modular and decentralised honeypot daemon that runs several canary versions of services that alerts when a service is (ab)used.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,221 | 🐛 45 | 🌐 Python | 📅 2026-08-13 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,452 | 🐛 1 | 🌐 Shell | 📅 2026-08-29 - All in one honeypot appliance from telecom provider T-Mobile
...
* SSH Honeypots
  ...
  * [endlessh](https://github.com/skeeto/endlessh) ⭐ 8,543 | 🐛 50 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner. ([docker image](https://hub.docker.com/r/linuxserver/endlessh))
  ...
  * [hnypots-agent)](https://github.com/joshrendek/hnypots-agent) ⭐ 39 | 🐛 1 | 🌐 PureBasic | 📅 2026-09-01 - SSH Server in Go that logs username and password combinations.
  ...
  * [ssh-honeypotd](https://github.com/sjinks/ssh-honeypotd) ⭐ 19 | 🐛 3 | 🌐 C | 📅 2026-08-27 - Low-interaction SSH honeypot written in C.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,143 | 🐛 5 | 🌐 Python | 📅 2026-09-01 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
