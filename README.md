...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 501,573 | 🐛 105 | 📅 2026-08-21.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,169 | 🐛 25 | 📅 2024-06-07 - Some overlap here for artifact analysis.
* [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,417 | 🐛 14 | 📅 2025-09-03 - Useful in network traffic analysis.
...
* Blockchain honeypots
  * [Ethereum-honey-pot](https://github.com/jeremyfritzen/Ethereum-honey-pot) ⭐ 14 | 🐛 3 | 🌐 Shell | 📅 2023-11-17 - Tool hacking-back hackers who tried to steal tokens.

* Web honeypots

  * [HellPot](https://github.com/yunginnanet/HellPot) ⭐ 1,148 | 🐛 13 | 🌐 Go | 📅 2025-12-19 - Honeypot that tries to crash the bots and clients that visit it's location.
  ...
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 643 | 🐛 11 | 🌐 Python | 📅 2026-08-30 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  ...
  * [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 195 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-30 - Self-hosted CAPTCHA that acts as an inline honeypot, detecting bots and vision AI agents through 40+ behavioral signals, headless browser fingerprinting, and SHA-256 proof of work.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-31 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
...
* Anti-honeypot stuff
  ...
  * [honeydet](https://github.com/referefref/honeydet) ⭐ 111 | 🐛 0 | 🌐 Go | 📅 2025-03-22 - Signature based honeypot detector tool written in Golang
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,217 | 🐛 45 | 🌐 Python | 📅 2026-08-13 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,450 | 🐛 1 | 🌐 Shell | 📅 2026-08-29 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2,168 | 🐛 6 | 🌐 Go | 📅 2026-08-31 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* SSH Honeypots
  ...
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,510 | 🐛 113 | 🌐 Python | 📅 2026-08-31 - Cowrie SSH Honeypot (based on kippo).
  ...
  * [hnypots-agent)](https://github.com/joshrendek/hnypots-agent) ⭐ 39 | 🐛 1 | 🌐 PureBasic | 📅 2026-08-31 - SSH Server in Go that logs username and password combinations.
  ...
  * [ssh-honeypotd](https://github.com/sjinks/ssh-honeypotd) ⭐ 20 | 🐛 3 | 🌐 C | 📅 2026-08-27 - Low-interaction SSH honeypot written in C.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,143 | 🐛 5 | 🌐 Python | 📅 2026-08-31 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
