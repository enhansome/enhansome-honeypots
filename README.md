...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 507,991 | 🐛 106 | 📅 2026-09-02.
...
* [awesome-pcaptools](https://github.com/caesar0301/awesome-pcaptools) ⭐ 3,426 | 🐛 14 | 📅 2025-09-03 - Useful in network traffic analysis.
...
* Web honeypots
  ...
  * [django-admin-honeypot](https://github.com/dmpayton/django-admin-honeypot) ⭐ 1,081 | 🐛 19 | 🌐 Python | 📅 2024-04-10 - Fake Django admin login screen to notify admins of attempted unauthorized access.
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 745 | 🐛 6 | 🌐 Python | 📅 2026-09-19 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-09-20 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
...
* Other/random
  ...
  * [FortiGate SSL-VPN Honeypot](https://github.com/PeterGabaldon/Fortigate.VPN-SSL.Honeypot) ⭐ 13 | 🐛 0 | 🌐 Python | 📅 2026-06-28 - Mimics FortiGate SSL-VPN devices to capture brute-force attempts, symlink exploit probes, and malicious IP telemetry.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,271 | 🐛 45 | 🌐 Python | 📅 2026-09-19 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,507 | 🐛 0 | 🌐 Shell | 📅 2026-09-04 - All in one honeypot appliance from telecom provider T-Mobile
...
* Server
  ...
  * [glutton](https://github.com/mushorg/glutton) ⭐ 310 | 🐛 23 | 🌐 Go | 📅 2026-08-30 - All eating honeypot.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,164 | 🐛 6 | 🌐 Python | 📅 2026-09-16 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
