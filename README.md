...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 505,888 | 🐛 106 | 📅 2026-09-02.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,193 | 🐛 25 | 📅 2024-06-07 - Some overlap here for artifact analysis.
...
* Web honeypots
  ...
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 722 | 🐛 6 | 🌐 Python | 📅 2026-09-11 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  ...
  * [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 211 | 🐛 0 | 🌐 JavaScript | 📅 2026-09-11 - Self-hosted CAPTCHA that acts as an inline honeypot, detecting bots and vision AI agents through 40+ behavioral signals, headless browser fingerprinting, and SHA-256 proof of work.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-09-14 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
  ...
  * Snare/Tanner - successors to Glastopf
    * [Snare](https://github.com/mushorg/snare) ⭐ 483 | 🐛 29 | 🌐 Python | 📅 2024-06-10 - Super Next generation Advanced Reactive honeypot.
  ...
  * WordPress honeypots
    ...
    * [WebDecoy](https://github.com/WebDecoy/wordpress-plugin) ⭐ 1 | 🐛 4 | 🌐 PHP | 📅 2026-09-13 - Zero-configuration WordPress plugin with invisible honeypot fields, behavioral analysis, and SHA-256 proof-of-work challenges to detect bots, headless browsers, and automation frameworks.
...
* Other/random
  ...
  * [OpenCanary](https://github.com/thinkst/opencanary) ⭐ 3,027 | 🐛 13 | 🌐 Python | 📅 2026-09-09 - Modular and decentralised honeypot daemon that runs several canary versions of services that alerts when a service is (ab)used.
...
* System instrumentation
  ...
  * [Fibratus](https://github.com/rabbitstack/fibratus) ⭐ 2,542 | 🐛 44 | 🌐 Go | 📅 2026-09-12 - Tool for exploration and tracing of the Windows kernel.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,242 | 🐛 46 | 🌐 Python | 📅 2026-09-04 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,491 | 🐛 0 | 🌐 Shell | 📅 2026-09-04 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2,173 | 🐛 6 | 🌐 Go | 📅 2026-09-14 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* SSH Honeypots
  ...
  * [endlessh](https://github.com/skeeto/endlessh) ⭐ 8,555 | 🐛 49 | 🌐 C | 📅 2024-06-03 - SSH tarpit that slowly sends an endless banner. ([docker image](https://hub.docker.com/r/linuxserver/endlessh))
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,534 | 🐛 92 | 🌐 Python | 📅 2026-09-14 - Cowrie SSH Honeypot (based on kippo).
...
* SIP
  ...
  * [SentryPeer](https://github.com/SentryPeer/SentryPeer) ⭐ 211 | 🐛 5 | 🌐 C | 📅 2026-09-14 - Protect your SIP Servers from bad actors.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,161 | 🐛 6 | 🌐 Python | 📅 2026-09-10 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
