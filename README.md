...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 501,273 | 🐛 105 | 📅 2026-08-21.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,166 | 🐛 25 | 📅 2024-06-07 - Some overlap here for artifact analysis.
...
* Web honeypots
  ...
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 642 | 🐛 12 | 🌐 Python | 📅 2026-08-29 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  ...
  * [FCaptcha](https://github.com/WebDecoy/FCaptcha) ⭐ 195 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-23 - Self-hosted CAPTCHA that acts as an inline honeypot, detecting bots and vision AI agents through 40+ behavioral signals, headless browser fingerprinting, and SHA-256 proof of work.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-30 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
...
* Service Honeypots
  ...
  * [honeypots](https://github.com/qeeqbox/honeypots) ⭐ 985 | 🐛 14 | 🌐 Python | 📅 2025-12-03 - 25 different honeypots in a single pypi package! (dns, ftp, httpproxy, http, https, imap, mysql, pop3, postgres, redis, smb, smtp, socks5, ssh, telnet, vnc, mssql, elastic, ldap, ntp, memcache, snmp, oracle, sip and irc).
  ...
  * [Trapster Commmunity](https://github.com/0xBallpoint/trapster-community) ⭐ 165 | 🐛 0 | 🌐 Python | 📅 2026-08-13 - Modural and easy to install Python Honeypot, with comprehensive alerting
  ...
  * [dhp](https://github.com/ciscocsirt/dhp) ⭐ 34 | 🐛 1 | 🌐 Python | 📅 2020-10-06 - Simple Docker Honeypot server emulating small snippets of the Docker HTTP API.
...
* VM monitoring and tools
  ...
  * [Antivmdetect](https://github.com/nsmfoo/antivmdetection) ⭐ 779 | 🐛 11 | 🌐 Python | 📅 2022-11-05 - Script to create templates to use with VirtualBox to make VM detection harder.
...
* Mobile Analysis Tool
  ...
  * [Androguard](https://github.com/androguard/androguard) ⭐ 6,215 | 🐛 45 | 🌐 Python | 📅 2026-08-13 - Reverse engineering, Malware and goodware analysis of Android applications and more.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,449 | 🐛 0 | 🌐 Shell | 📅 2026-08-29 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2,167 | 🐛 6 | 🌐 Go | 📅 2026-08-24 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* Server
  ...
  * [honeytrap](https://github.com/tillmannw/honeytrap) ⭐ 96 | 🐛 4 | 🌐 C | 📅 2017-06-04 - Low-interaction honeypot and network security tool written to catch attacks against TCP and UDP services.
...
* SSH Honeypots
  ...
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,510 | 🐛 119 | 🌐 Python | 📅 2026-08-27 - Cowrie SSH Honeypot (based on kippo).
  ...
  * [hnypots-agent)](https://github.com/joshrendek/hnypots-agent) ⭐ 39 | 🐛 1 | 🌐 PureBasic | 📅 2026-08-29 - SSH Server in Go that logs username and password combinations.
...
* SIP
  ...
  * [SentryPeer](https://github.com/SentryPeer/SentryPeer) ⭐ 212 | 🐛 3 | 🌐 C | 📅 2026-08-28 - Protect your SIP Servers from bad actors.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,143 | 🐛 5 | 🌐 Python | 📅 2026-08-28 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
