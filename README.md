...
Discover more awesome lists at [sindresorhus/awesome](https://github.com/sindresorhus/awesome) ⭐ 497,059 | 🐛 102 | 📅 2026-06-30.
...
* [awesome-malware-analysis](https://github.com/rshipp/awesome-malware-analysis) ⭐ 14,129 | 🐛 25 | 📅 2024-06-07 - Some overlap here for artifact analysis.
...
* Database Honeypots
  * [Acra](https://github.com/cossacklabs/acra) ⭐ 1,492 | 🐛 25 | 🌐 Go | 📅 2026-04-23 - Effective SQL database protection suite: strong selective encryption, SQL injections prevention, intrusion detection system based on using honeypots/poison records in the database.
...
* Web honeypots
  ...
  * [HellPot](https://github.com/yunginnanet/HellPot) ⭐ 1,141 | 🐛 13 | 🌐 Go | 📅 2025-12-19 - Honeypot that tries to crash the bots and clients that visit it's location.
  ...
  * [Krawl](https://github.com/BlessedRebuS/Krawl) ⭐ 633 | 🐛 10 | 🌐 Python | 📅 2026-08-17 - Lightweight deception server and anti‑crawler that deploys realistic fake web applications with low‑hanging vulnerabilities and randomly generated decoy data.
  ...
  * [flux](https://github.com/andrewmichaelsmith/flux) ⭐ 4 | 🐛 1 | 🌐 Python | 📅 2026-08-17 - Dynamic Web Honeypot with Canary Token Integration that is being actively maintained by LLMs.
...
* Other/random
  ...
  * [OpenCanary](https://github.com/thinkst/opencanary) ⭐ 2,991 | 🐛 12 | 🌐 Python | 📅 2026-08-13 - Modular and decentralised honeypot daemon that runs several canary versions of services that alerts when a service is (ab)used.
...
* Low interaction honeypot
  ...
  * [T-Pot](https://github.com/dtag-dev-sec/tpotce) ⭐ 9,418 | 🐛 4 | 🌐 Shell | 📅 2026-08-04 - All in one honeypot appliance from telecom provider T-Mobile
  * [beelzebub](https://github.com/mariocandela/beelzebub) ⭐ 2,147 | 🐛 9 | 🌐 Go | 📅 2026-08-18 - A secure honeypot framework, extremely easy to configure by yaml 🚀
...
* SSH Honeypots
  ...
  * [Cowrie](https://github.com/cowrie/cowrie) ⭐ 6,494 | 🐛 121 | 🌐 Python | 📅 2026-08-17 - Cowrie SSH Honeypot (based on kippo).
...
* Dockerized Low Interaction packaging
  ...
  * [Dockerized Thug](https://hub.docker.com/r/honeynet/thug/) - Dockerized [Thug](https://github.com/buffer/thug) ⭐ 1,041 | 🐛 6 | 🌐 Python | 📅 2026-08-17 to analyze malicious web content.
...
* SIP
  ...
  * [SentryPeer](https://github.com/SentryPeer/SentryPeer) ⭐ 212 | 🐛 4 | 🌐 C | 📅 2026-08-14 - Protect your SIP Servers from bad actors.
...
* Honeytokens
  * [CanaryTokens](https://github.com/thinkst/canarytokens) ⭐ 2,113 | 🐛 5 | 🌐 Python | 📅 2026-08-17 - Self-hostable honeytoken generator and reporting dashboard; demo version available at [CanaryTokens.org](https://canarytokens.org/generate).
